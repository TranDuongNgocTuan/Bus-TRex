...
<link rel="stylesheet" type="text/css" href="../tooltipster/dist/css/plugins/tooltipster/sideTip/themes/tooltipster-sideTip-noir-customized.css" />
...
<body >
				...
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
					...
					<div class="date-picker">
						<div class="pull-left date-wapper">
							<button id="btPrevDate" style="" type="button" class="btn btn-default"><i class="fa fa-caret-left fa-lg"></i></button>
							...
							<button id="btNextDate" type="button" class="btn btn-default"><i class="fa fa-caret-right fa-lg"></i></button>
						</div>
				...
				<div class="logo col-md-4 col-sm-4 hidden-xs mt10">
					<div class="pull-right col-md-12">
						<div class="col-md-5 pr0 text-right">
							<img height="42" src="../../../../../../../Java/Project/template/img/lock-sercurity.svg">
						</div>
	...
	<div class="barsearch">
		<div class="container">
			<table class="table">
				<tbody>
					<tr>
						<td><div class="dropdown pull-left">
						...
						<td><div class="dropdown pull-left">
							<i class="dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-clock-o"></i><span>Giờ đi</span></i>
							<ul class="dropdown-menu">
								<li><a href="#">HTML</a></li>
								<li><a href="#">CSS</a></li>
								<li><a href="#">JavaScript</a></li>
						...
						<td><div class="dropdown pull-left">
							<i class="dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-puzzle-piece"></i><span>Sơ đồ ghế</span></i>
							<ul class="dropdown-menu">
								<li><a href="#">HTML</a></li>
								<li><a href="#">CSS</a></li>
								<li><a href="#">JavaScript</a></li>
						...
						<td><div class="dropdown pull-left">
							<i class="dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-ticket"></i><span>Vé xe</span></i>
							<ul class="dropdown-menu">
								<li><a href="#">HTML</a></li>
								<li><a href="#">CSS</a></li>
								<li><a href="#">JavaScript</a></li>
			...
			<div class="row">
				<table class="table table-borderless">
					<tr>
						...
						</td> <!-- end ìnformation bus -->
						<td class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<div class="pull-left">
								<i class="glyphicon glyphicon-time"></i>
							</div>
							<div class="container-time">
								<h4 class="">15:30→08:20</h4>
								<p>Thời gian: 16h50' </p>
								<span class="tooltiphover" data-tooltip-content="#tooltip_content">Bến Xe Khách Đà Nãng<i class="fa fa-sort-desc"></i></span>
								<span class="tooltiphover" data-tooltip-content="#tooltip_content">→Bến Xe Khách Tam Kỳ<i class="fa fa-sort-desc"></i></span>
							</div>
						</td><!-- end time from to -->
						...
						<td class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
							<div class="">
								<h4 class="money">300000đ</h4>
								<div class="container-ticket text-center" data-toggle="collapse" data-target="#demo">
					...
					<tr>
						<td class="col-xs-12 col-sm-12 col-md-12 col-lg-12 info" colspan="5">
							<div id="demo" class="collapse info-wapper">
											...
											<form action="" method="POST" role="form" class="info-form">
												...
												<div class="row">
													<div class="form-group form-inline">
														...
														<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
															<input type="text" required class="form-control" placeholder="Tran Van A">
														</div>
												...
												<div class="row">
													<div class="form-group form-inline">
														...
														<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
															<input type="phone" required class="form-control" placeholder="VD: 0912345678">
														</div>
												...
												<div class="row">
													<div class="form-group form-inline">
														...
														<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
															<input type="email" required class="form-control" placeholder="vexe@gmail.com">
														</div>

													</div>
												</div>	
												<button type="submit" class="btn btn-primary pull-right container-ticket text-center" ><i class="fa fa-bus"></i><span>Tiếp tục</span></button>
											</form>
										</div>
										<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
											<table class="table">
												<tr>
													<td>Tuyến đường</td>
													<td class="info-table-ticket">Bến xe khách Đà Nẵng - VP Buôn Ma Thuộc</td>
												</tr>
												<tr>
													<td>Xuất phát</td>
										...
										<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
											...
											<div class="row">
												<div class="contact">
													...
													<h2 class="number-mobile"><i class="glyphicon glyphicon-phone-alt"></i>05116 505 050</h2>
												</div>
											</div>
										</div>
									</div>
								</div><!-- end information ticket -->
	...
	<footer>
		<div class="container">
			<div class="row">
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
					<img src="../../../../../../../Java/Project/template/img/icon-vxr.svg" class="pull-left" width="55px" height="55px">
				...
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
							<img src="../../../../../../../Java/Project/template/img/certificate1.png">
						</div>
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
							<img src="../../../../../../../Java/Project/template/img/certificate1.png">
						</div>
	...
	<div class="tooltip" style="display: none">
		<span id="tooltip_content">
			...
			<p class="localgo">This is the content of my tooltip!</p>
			<span></span>
		</span>
	</div>
