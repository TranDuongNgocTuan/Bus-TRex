            ...
            <div class="logo col-md-4 col-sm-4 hidden-xs mt10">
                <div class="pull-right col-md-12">
                    <div class="col-md-5 pr0 text-right">
                        <img height="42" src="webjars/img/lock-sercurity.svg">
                    </div>
                ...
                <tr>
                    ...
                    <td class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        ...
                        <div class="container-time">
                            ...
                            <p>Thời gian: 16h50' </p>
                            <span class="tooltiphover" data-tooltip-content="#tooltip_content">Bến Xe Khách Đà Nãng<i
                                    class="fa fa-sort-desc"></i></span>
                            <span class="tooltiphover" data-tooltip-content="#tooltip_content">→Bến Xe Khách Tam Kỳ<i
                                    class="fa fa-sort-desc"></i></span>
                        </div>
                    </td>
                    <!-- end time from to -->
                                ...
                                <div class="row">
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                        <form action="" method="POST" role="form" class="info-form">
                                            ...
                                            <button type="submit"
                                                    class="btn btn-primary pull-right container-ticket text-center"><i
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                        <table class="table">
                                            <tr>
                                                <td>Tuyến đường</td>
                                                <td class="info-table-ticket">Bến xe khách Đà Nẵng - VP Buôn Ma Thuộc
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Xuất phát</td>
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                        ...
                                        <div class="row">
                                            <div class="contact">
                                                ...
                                                <h2 class="number-mobile"><i class="glyphicon glyphicon-phone-alt"></i>05116
                                                    505 050</h2>
                                            </div>
                                        </div>
                                    </div>
