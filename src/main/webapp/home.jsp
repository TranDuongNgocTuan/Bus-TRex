          ...
          <form id="searchForm" action="/findticket">
            <fieldset class="row">
              ...
              <div class="form-inline col-md-6 col-md-offset-6 col-xs-12 clearfix search-submit-container">
                <button id="searchSubmit" class="submit-btn search-btn fr uppercase" tabindex="6" type="submit" name="searchSubmit">Tìm Vé</button>
              </div>
            </fieldset>
          </form>
        </div>
  ...
  <div class="container">
    <div class="row hidden-sm hidden-xs">
      ...
      <div class="col-md-3 hidden-xs">
        ...
        <div class="social col-08 clearfix">
          ...
          <a class="social-icon google-plus" rel="nofollow" title="Google+" href="#" target="_blank">Google+</a>
    ...
    <div class="copyright-panel" itemscope itemtype="http://schema.org/Organization">
      <div class="col col-md-8 footer-info-panel hidden-sm hidden-xs">
        ...
        <p>
          Địa chỉ: <a href="https://goo.gl/maps/SzfDTaj3wLP2" title="Xem bản đồ" target="_blank"><span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress"><span itemprop="streetAddress">92 Quang Trung</span>, <span itemprop="addressLocality">Q.Hải Châu</span>, <span itemprop="addressRegion">TP. Đà Nẵng</span>, <span itemprop="addressCountry">Việt Nam</span></span></a>
          <br>
